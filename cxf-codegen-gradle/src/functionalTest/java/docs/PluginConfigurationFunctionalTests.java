...
class PluginConfigurationFunctionalTests {
    ...
    void managingDependencyVersionsWithExtension(GradleBuild gradleBuild) {
        ...
        assertThat(result.getOutput())
                .contains(
                        "[org.slf4j:slf4j-nop:2.0.18, org.apache.cxf:cxf-core:3.2.0, org.apache.cxf:cxf-tools-common:3.2.0, org.apache.cxf:cxf-tools-wsdlto-core:3.2.0, org.apache.cxf:cxf-tools-wsdlto-databinding-jaxb:3.2.0, org.apache.cxf:cxf-tools-wsdlto-frontend-jaxws:3.2.0, org.apache.cxf:cxf-tools-wsdlto-frontend-javascript:3.2.0]");
    }
