...
* https://ciscoo.github.io/cxf-codegen-gradle/docs/1.0.0-rc.1/user-guide/[User Guide]
* https://ciscoo.github.io/cxf-codegen-gradle/docs/1.0.0-rc.1/api/index.html[Javadoc]
