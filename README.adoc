...
* https://ciscoo.github.io/cxf-codegen-gradle/docs/1.0.0-rc.2/user-guide/[User Guide]
* https://ciscoo.github.io/cxf-codegen-gradle/docs/1.0.0-rc.2/api/index.html[Javadoc]
...
You will need https://openjdk.java.net/projects/jdk/16/[JDK 16] to build CXF Codegen.
