...
public interface Option extends GenericWsdlOption {
	...
	/**
	 * Specifies <a href=
	 * "https://javaee.github.io/jaxb-v2/doc/user-guide/ch04.html">arguments</a>
	 * that are passed directly to the XJC processor when using the JAXB data
	 * binding.
	 *
	 ...
	 * asynchronous calls, similar to {@code enableAsyncMapping} in a JAX-WS binding
	 * file.
	 *
	...
	/**
	 * Specifies subsequently generated Java class methods to have wrapper style,
	 * similar to {@code enableWrapperStyle} in JAX-WS binding file.
	 *
	 * @return bare methods
	 */
	...
	/**
	 * Specifies subsequently generated Java class methods to enable mime:content
	 * mapping, similar to {@code enableMIMEContent} in JAX-WS binding file.
	 *
	 * @return mime methods
	 */
	 ...
	 *
	 * <p>
	 * Optionally specifies the Java package name used by types described in the
	 * excluded namespace(s) using schema-namespace[=java-packagename]
	 *
	...
	/**
	 * Enables or disables the loading of the default namespace package name
	 * mapping.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * The values are evaluated as per
	 * {@link org.gradle.api.file.Directory#file(String)} from
	 * {@link org.gradle.api.file.ProjectLayout#getProjectDirectory()}
	 *
	...
	/**
	 * Specifies that the {@code wsdlurl} contains a plain text, new line delimited,
	 * list of {@code wsdlurl}s instead of the WSDL itself.
	 *
	...
	/**
	 * Specifies the databinding. Currently supports JAXB, XMLBeans, SDO (sdo-static
	 ...
	 *
	 * <p>
	 * If not set, {@code wsdl2java} defaults to {@code WSDL1.1}; currently supports
	 ...
	 * defined in the {@code wsdl:binding}, but not {@code wsdl:portType} section.)
	 *
	 * <p>
	 * Processing the SOAP headers requires the SOAP binding JARs available on the
	 * classpath which was not the default in CXF 2.4.x and older. You may need to
	 * add a dependency to {@code cxf-rt-binding-soap} for this flag to work.
	 *
	 * <p>
	...
	/**
	 * Specifies the superclass for fault beans generated from {@code wsdl:fault}
	 * elements
	 *
	 * <p>
	...
	/**
	 * Enables or disables adding the {@code @Generated} annotation to classes
	 * generated.
	 *
	...
	/**
	 * Enables or disables automatically resolving naming conflicts without
	...
	/**
	 * For compatibility with CXF 2.0, this flag directs the code generator to
	 * generate the older CXF proprietary WS-Addressing types instead of the JAX-WS
	 * 2.1 compliant WS-Addressing types.
	 *
	...
	/**
	 * Enables or disables disregarding the rule given in section 2.3.1.2(v) of the
	 * JAX-WS 2.2 specification disallowing element references when using
