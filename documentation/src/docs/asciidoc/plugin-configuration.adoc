...
[source,groovy]
----
include::../gradle/plugin-configuration/plugin-extension.gradle[]
----
...
[source,groovy]
----
include::../gradle/plugin-configuration/managing-dependency-versions.gradle[]
----
...
[source,kotlin]
----
include::../gradle/plugin-configuration/managing-dependency-versions.gradle.kts[]
----
