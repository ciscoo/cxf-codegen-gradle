...
Out-of-the-box, the following dependencies are added (v3.5.1):
...
These are the same dependencies defined in the Maven plugin's https://github.com/apache/cxf/blob/cxf-3.5.1/maven-plugins/codegen-plugin/pom.xml#L71..L106[POM].
