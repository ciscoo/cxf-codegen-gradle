...
****
To keep the plugin as simple as possible, there will not be any version specific workarounds for older versions
of Gradle or any Gradle version for that matter.
