...
tool requires. Review <<plugin-configuration.adoc#dependency-configuration, dependency configuration>> documentation on how to
...
the same thing. Refer to the <<generating-java.adoc#default-options, default options>> section for details.
====
...
[source,kotlin]
----
include::example$examples/jaxws-binding-file.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$examples/jaxws-binding-file.gradle[tags=code]
----
...
[source,kotlin]
----
include::example$examples/specify-data-binding.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$examples/specify-data-binding.gradle[tags=code]
----
...
[source,kotlin]
----
include::example$examples/service-name.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$examples/service-name.gradle[tags=code]
----
...
[source,kotlin]
----
include::example$examples/loading-wsdl.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$examples/loading-wsdl.gradle[tags=code]
----
...
[source,kotlin]
----
include::example$examples/using-xjc-extensions.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$examples/using-xjc-extensions.gradle[tags=code]
----
