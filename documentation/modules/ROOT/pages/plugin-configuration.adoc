...
[source,kotlin]
----
include::example$plugin-configuration/extension.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$plugin-configuration/extension.gradle[tags=code]
----
...
[source,kotlin]
----
include::example$plugin-configuration/managing-dependency-versions-extension.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$plugin-configuration/managing-dependency-versions-extension.gradle[tags=code]
----
...
[source,kotlin]
----
include::example$plugin-configuration/managing-dependency-versions.gradle.kts[tags=code]
----
...
[source,groovy]
----
include::example$plugin-configuration/managing-dependency-versions.gradle[tags=code]
----
